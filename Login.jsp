...
<body class="bg">
    ...
    <div class="container">
        ...
        <div class="row">
    		<div align="center" class="col-md-12" style="font-size:30px;font-size: 30px;font-style: italic;color: darkblue;font-weight: 800;">${projectName}</div>
		</div>
        
        <img id="profile-img" src="../img/loginicon.png"   class="img-responsive" />
            <p id="profile-name" class="profile-name-card"></p>
         <form  action="?a=validateLogin" method="POST">
<span id="reauth-email" class="reauth-email"></span>
  <div class="form-group"> 
  
     <input type="text" style="margin-bottom:10px"  id="txtusername" maxlength="30" name="txtusername" class="form-control"  placeholder="Username" required autofocus>
